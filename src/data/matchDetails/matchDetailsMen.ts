/* ==================================================
   MATCH DETAILS 2026 — MEN
   ================================================== */

import type { MatchDetails } from "./types";

export const matchDetailsMen: MatchDetails[] = [
  // ==================================================
  // BARBARIANS
  // ==================================================
...

  {
    ...
    performances: [
      ...
      { category: "Venue", player: "One New Zealand Stadium", value: "Christchurch" },
    ],
  },

  {
    ...
    performances: [
      ...
      { category: "Selection note", player: "Jock Campbell", value: "Returns at fullback" },
    ],
  },

  {
    ...
    performances: [
      ...
      { category: "Venue", player: "Chichibunomiya Rugby Stadium", value: "Tokyo" },
    ],
  },

  {
    ...
    performances: [
      ...
      { category: "Venue", player: "Cardiff City Stadium", value: "Cardiff" },
    ],
  },

  {
    ...
    performances: [
      ...
      { category: "Venue", player: "Estadio Mario Alberto Kempes", value: "Cordoba" },
    ],
  },
  ...
  // ==================================================
  // THE RIVALRY TOUR 2026 — TEST SERIES
  // ==================================================
  ...
  lineups: {
    ...
    awayStarting: [
      // All Blacks TBD - not announced yet
      { number: 1, name: "TBD" },
      { number: 2, name: "TBD" },
      { number: 3, name: "TBD" },
      { number: 4, name: "TBD" },
  ...
  performances: [
    ...
    { category: "Referee", player: "Nika Amashukeli", value: "GRU" },           // ✅ Corrected from Angus Gardner
    { category: "Assistant Referee 1", player: "Angus Gardner", value: "RA" },   // ✅ Corrected from Nika Amashukeli
    { category: "Assistant Referee 2", player: "Christophe Ridley", value: "RFU" },
    { category: "TMO", player: "Eric Gauzins", value: "FFR" },                  // ✅ Corrected from Brett Cronan
    { category: "FPRO", player: "Brett Cronan", value: "RA" },                  // ✅ Added FPRO
  ],
},
...

  {
    ...
    performances: [
      { category: "Coach", player: "Felipe Contepomi", value: "Argentina" },
      { category: "Coach", player: "Joe Schmidt", value: "Australia" },
      { category: "Captain", player: "Pablo Matera", value: "Argentina" },
      { category: "Captain", player: "Allan Alaalatoa", value: "Australia" },
      { category: "Venue", player: "Estadio 23 de Agosto", value: "Jujuy" },
      { category: "Referee", player: "TBD", value: "TBD" },
      { category: "Assistant Referee 1", player: "TBD", value: "TBD" },
      { category: "Assistant Referee 2", player: "TBD", value: "TBD" },
      { category: "TMO", player: "TBD", value: "TBD" },
    ],
  },

{
  ...
  lineups: {
    homeStarting: [
      // Argentina lineups TBD - team announced 2 days before (Thursday) [citation:4]
      { number: 1, name: "TBD" },
      { number: 2, name: "TBD" },
      { number: 3, name: "TBD" },
      { number: 4, name: "TBD" },
  ...
  performances: [
    ...
    { category: "Venue", player: "Estadio Malvinas Argentinas", value: "Mendoza" },
    { category: "Referee", player: "TBD", value: "TBD" },
    { category: "Assistant Referee 1", player: "TBD", value: "TBD" },
    { category: "Assistant Referee 2", player: "TBD", value: "TBD" },
    { category: "TMO", player: "TBD", value: "TBD" },
