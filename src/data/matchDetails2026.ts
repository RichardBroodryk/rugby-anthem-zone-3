...
export const matchDetails2026: MatchDetails[] = [
  ...
  timeline: [
    { minute: "0'", label: "Kick-off — Wellington Regional Stadium, Wellington" },
    { minute: "40'", label: "Half Time" },
    { minute: "80'", label: "Full Time" },
  ],
  lineups: {
  ...
  performances: [
    ...
    {
      category: "Venue",
      player: "Wellington Regional Stadium",
      value: "Wellington",
    },
  ],
},

{
  ...
  lineups: {
    ...
    awayStarting: [
      // France TBD - placeholder structure
      { number: 1, name: "TBD" },
      { number: 2, name: "TBD" },
      { number: 3, name: "TBD" },
      { number: 4, name: "TBD" },
...

{
  ...
  lineups: {
    ...
    awayStarting: [
      // Scotland TBD - confirmed changes: Finn Russell starts, Zander Fagerson and Gregor Brown come in, Sione Tuipulotu captains
      { number: 1, name: "TBD" },
      { number: 2, name: "TBD" },
...

{
  ...
  lineups: {
    ...
    awayStarting: [
      // Ireland - known: Beirne captains, Bohan, Illo, Jansen, Ward debutants
      { number: 1, name: "TBD" },
      { number: 2, name: "TBD" },
      { number: 3, name: "TBD" },
      { number: 4, name: "TBD" },
      { number: 5, name: "Tadhg Beirne (C)" },
      { number: 6, name: "TBD" },
      { number: 7, name: "TBD" },
      { number: 8, name: "TBD" },
      { number: 9, name: "TBD" },
...

{
  ...
  lineups: {
    homeStarting: [
      // Argentina TBD - likely close to Round 1 with adjustments
      { number: 1, name: "TBD" },
      { number: 2, name: "TBD" },
      { number: 3, name: "TBD" },
      { number: 4, name: "TBD" },
  ...
  performances: [
    ...
    {
      category: "Venue",
      player: "Estadio San Juan del Bicentenario",
      value: "San Juan",
    },
  ],
},

// ================= WOMEN'S OTHER EXISTING DATA =================
